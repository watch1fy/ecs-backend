...
syncNsp.addEventHandler(
  new EventHandler("play", (socket: Socket, { detail, toRoom }, cb) => {
    socket.broadcast
      .to(toRoom)
...
syncNsp.addEventHandler(
  new EventHandler("pause", (socket: Socket, { detail, toRoom }, cb) => {
    socket.broadcast
      .to(toRoom)
...
syncNsp.addEventHandler(
  new EventHandler("play-fail", (socket: Socket, { detail, toRoom }, cb) => {
    socket.broadcast
      .to(toRoom)
...
syncNsp.addEventHandler(
  new EventHandler("seek", (socket: Socket, { detail, toRoom }, cb) => {
    socket.broadcast
      .to(toRoom)
...
syncNsp.addEventHandler(
  new EventHandler("waiting", (socket: Socket, { detail, toRoom }, cb) => {
    socket.broadcast
      .to(toRoom)
